...
```
augment-extensions/
├── .augment/                    # Configuration and active definitions
│   ├── commands/                # OpenSpec command definitions
│   ├── skills/                  # OpenSpec skill definitions
│   ├── mcp/                     # MCP server configuration
│   ├── coordination.json        # Coordination manifest
│   └── extensions.json          # Linked modules configuration
├── .augment-guidelines/         # Guidelines and documentation
│   ├── workflows/               # Workflow documentation
│   ├── repository-rules/        # Repository-specific rules
│   ├── system-integration/      # System integration docs
...
**Current files**:
- Configuration files (coordination.json, extensions.json)
