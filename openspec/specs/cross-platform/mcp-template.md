---
id: cross-platform/mcp-template
status: active
relatedTasks: [bd-xplat1, bd-xplat1-1, bd-xplat4-1, bd-xplat4-2]
relatedRules: [module-development.md, no-em-dash.md]
priority: high
labels: [augx, cli, cross-platform, mcp, beads, template, non-breaking]
---
