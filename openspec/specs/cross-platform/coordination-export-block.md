---
id: cross-platform/coordination-export-block
status: active
relatedTasks: [bd-xplat1, bd-xplat1-1, bd-xplat1-2]
relatedRules: [coordination-system.md, module-development.md, no-em-dash.md]
priority: high
labels: [augx, cli, cross-platform, coordination, schema, configuration, non-breaking]
---
